<x-dashboard-layout title="لوحة التحكم">
    ...
    <div class="table-responsive">
        <table class="table table-striped text-center" dir="rtl">
            ...
            <tbody>
                @forelse($waiting_products as $product)
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route('dashboard.products.show',$product->id)}}" title="عرض المزيد">
                ...
                <tr>
                    <td colspan="8"> لا يوجد طلبات انتظار. </td>
                </tr>
    ...
    {{$waiting_products->withQueryString()->links()}}
